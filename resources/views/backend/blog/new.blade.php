...
<div class="form-floating">
  <textarea class="form-control" name="details" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">{{old('details')}}</textarea>
</div>

  <button type="submit" class="btn btn-primary btn-block mt-3">Add Blog</button>
</form>
