...
<div class="form-group">
  ...
  <input type="text" class="form-control mb-3" name="name" id="child_category" value="{{$area->name}}">
</div>

<div class="form-group">
  <label for="sub-category" class="h6">Price</label>
  <input type="text" class="form-control mb-3" name="price" id="child_category" value="{{$area->price}}">
</div>

{{-- <label for="district" class="h6">Select District</label>

<select class="custom-select" id="district" name="district_id">
  ...
  <button type="submit" class="btn btn-primary btn-block mt-3">Edit Area</button>
</form>
