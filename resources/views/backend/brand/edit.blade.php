...
<h3 class="my-3">Edit Brand</h3>
<form action="{{route("admin.brand.update", $brand->id)}}" method="post" enctype="multipart/form-data">
@csrf
 <div class="form-group">
    <label for="sub-category" class="h6">Brand Name</label>
<input type="text" class="form-control mb-3" name="name" id="child_category" value="{{$brand->name}}">
  </div>
...
<div class="mb-3">
  ...
  <button type="submit" class="btn btn-primary btn-block mt-3">Edit Brand</button>
</form>
