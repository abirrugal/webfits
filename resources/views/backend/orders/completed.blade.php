...
<ul class="nav nav-tabs my-4">
  ...
  <li class="nav-item">
    <a class="nav-link " href="{{route('admin.orders.processing')}}">Processing order</a>
  </li>

  <li class="nav-item">
    <a class="nav-link active" href="#">Completed order</a>
  </li>
...
<div class="well">
    <h3 class="my-4">Completed Orders List</h3>
