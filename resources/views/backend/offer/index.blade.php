...
<ul class="nav nav-tabs my-4">
    ...
    <li class="nav-item">
        <a class="nav-link " href="{{route('admin.offer.new')}}">Add Category</a>
    </li>
</ul>
<div class="well">
    <h3 class="my-4">Category List</h3>
    <p>
        <a class="btn btn-success" href="{{route('admin.offer.new')}}">Add Category</a>
    </p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{route('admin.offer.edit', $category->id)}}" class="mt-2 btn btn-warning me-3">Edit</a>
